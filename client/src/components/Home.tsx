...
const Home: React.FC = () => {
  ...
  return (
    <div className={classes.root}>
      ...
      <p>
        Welcome to the clan manager for Oasis. Here you can create and manage
        your clans events, members, updates, etc...
      </p>
      <ul>
        <li>Create and manage clans using the Clan Dashboard</li>
        <li>
          Post blog updates, images, and even link videos on recent clan
          adventures
        </li>
