        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AlliedOrNot = table.Column<int>(nullable: false),
                    Pending = table.Column<bool>(nullable: false),
                    Accepted = table.Column<bool>(nullable: false),
                    ClanId = table.Column<int>(nullable: false),
                    ClanId_2 = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Allegiances", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Allegiances_Clans_ClanId",
                        column: x => x.ClanId,
                        principalTable: "Clans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Allegiances_Clans_ClanId_2",
                        column: x => x.ClanId_2,
                        principalTable: "Clans",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Allegiances_ClanId",
                table: "Allegiances",
                column: "ClanId");

            migrationBuilder.CreateIndex(
                name: "IX_Allegiances_ClanId_2",
                table: "Allegiances",
                column: "ClanId_2");
